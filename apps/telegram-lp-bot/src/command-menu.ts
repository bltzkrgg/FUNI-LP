export const FUNI_COMMAND_MENU=[
 ...
 {command:'config',description:'Show or update safe runtime settings'},
...
export const HELP_TEXT=[
 ...
 '/config — show or update safe runtime settings; /config dry_run false requires button confirmation.',
